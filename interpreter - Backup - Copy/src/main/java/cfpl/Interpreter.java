...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void>{
    ...
    public Void visitVarStmt(Stmt.Var stmt) {
        Object value = null;
        //storeDataType.put(stmt.name.lexeme, stmt.dataType);
    ...
    public Object visitUnaryExpr(Expr.Unary expr) {
        ...
        switch (expr.operator.type) {
            case NOT:
                /*System.out.println("Unary: right:"+right); //remove later
  ...
  public Object visitBinaryExpr(Expr.Binary expr) {
    ...
    switch (expr.operator.type) {
            ...
            case PLUS:
                ...
                if (left instanceof Double && right instanceof Boolean)
                    return (Double)left + right.toString();
                if (left instanceof Boolean && right instanceof Double)
                    return left.toString() + (Double)right;
